...
public class CategoriaDTO implements Serializable{
	...
	public Categoria convertToEntity() {
		return new Categoria(getIdCategoria(),
				getDescricaoCategoria(), isFlAtivo());
	}
// Entidade vai pro banco e a DTO será exportado pela API
	
//	public Categoria convertDtoToEntity(CategoriaDTO categoriaDto) {
//		return new Categoria(categoriaDto.getIdCategoria(),
//				categoriaDto.getDescricaoCategoria(), categoriaDto.isFlAtivo());
//	}
