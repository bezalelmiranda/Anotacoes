...
public class NotaDTO implements Serializable {
	...
	public NotaEntity convertToEntity() {
		return new NotaEntity(getIdNota(), getTituloNota(), getTextoAnotacao(),  getCategoria().convertToEntity());
	}
	...
	public void setTextoAnotacao(String tesxtoAnotacao) {
		this.textoAnotacao = tesxtoAnotacao;
	}
